Необходимо улучшить свой класс из [предыдущей лабораторной работы](https://github.com/eeeeagle/ADS_1.2), полностью делегировав управление памятью стандартному контейнеру.
